      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-container-style u-expanded-width-lg u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-group u-group-1">
          <div class="u-container-layout">
            <input type="submit" value="��ü" class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-1">
            <input type="submit" value="����"class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-2">
            <input type="submit" value="��õ"class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-3">
            <input type="submit" value="����"class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-4">
            <input type="submit" value="����"class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-5">
            <input type="submit" value="�λ�"class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-6">
            <input type="submit" value="���"class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-7">
            <input type="submit" value="�뱸"class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-8">
            <input type="submit" value="����"class="u-black u-border-none u-btn u-btn-round u-button-style u-hover -grey-70 u-radius-6 u-btn-9">
            <input type="submit" value="��⵵"class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-10">
            <input type="submit" value="��û��"class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-11">
            <input type="submit" value="����"class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-12">
            <input type="submit" value="���"class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-13">
            <input type="submit" value="������"class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-14">
          </div>
        </div>
        ...
        <div class="u-container-style u-group u-shape-rectangle u-group-2">
          <div class="u-container-layout u-container-layout-2">
            ...
            <a href="DJLessonWriter.jsp" class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-15">�� �ۼ�</a>
          </div>
        </div>
          ...
          <div class="u-container-layout u-container-layout-3">
            ...
            <form action="LessonWriteService.do" method="POST" enctype="multipart/form-data">
              <div class="u-container-layout u-container-layout-4">
                <h5 class="u-text u-text-default u-text-4">���� �̹��� ���� ÷��</h5><br>
        ...
        <div class="u-form u-form-1">
            <div class="u-form-group u-form-name u-form-group-1">
              <label for="name-3b9a" class="u-label u-label-1">�� ����</label>
            ...
            <div class="u-form-group u-form-select u-form-group-2">
              <label for="select-7dfb" class="u-label u-label-2">����</label>
            ...
            <div class="u-form-group u-form-message u-form-group-3">
              <label for="message-3b9a" class="u-label u-label-3">���� ����</label>
            ...
            <div class="u-form-group u-form-textarea u-form-group-4">
              <label for="textarea-c5a6" class="u-label u-label-4">��Ʈ������</label>
            ...
            <div class="u-form-group u-form-textarea u-form-group-5">
              <label for="textarea-da7c" class="u-label u-label-5">���</label>
            ...
            <div class="u-form-group u-form-textarea u-form-group-6">
              <label for="textarea-a316" class="u-label u-label-6">��� �� ȯ�ұ���</label>
            ...
            <div class="u-align-center u-form-group u-form-submit">
              <input type ="submit" value = "�� �ۼ�" class="u-border-2 u-border-black u-btn u-btn-rectangle u-btn-submit u-button-style u-none u-btn-17">
