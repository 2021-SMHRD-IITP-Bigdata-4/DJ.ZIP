    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-6e34">
      <div class="u-align-left u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
          <form action="JoinService.do" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;" redirect="true">
            ...
            <div class="u-form-group u-form-radiobutton u-form-group-6">
              <div class="u-form-radio-button-wrapper">
                <input type="radio" name="radiobutton" value="있음">
                <label class="u-custom-font u-label u-text-font u-label-6" for="radiobutton">있음</label>
                <br>
                <input type="radio" name="radiobutton" value="없음">
            ...
            <a href="Home.jsp" class="u-black u-border-none u-btn u-btn-round u-btn-submit u-button-style u-radius-10 u-text-active-grey-10 u-text-hover-grey-10 u-btn-1">회원가입</a>
          </form>
        </div>
      </div>
    </section>
