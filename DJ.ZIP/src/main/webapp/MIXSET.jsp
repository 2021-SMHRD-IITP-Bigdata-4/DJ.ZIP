					...
					<ul class="u-custom-font u-font-oswald u-nav u-unstyled u-nav-1">
						...
						<div class="u-nav-popup">
								<ul class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-nav-2">
									...
									<li class="u-nav-item"><a class="u-button-style u-nav-link u-text-hover-grey-70 u-white">레슨목록</a></li>
					...
					<ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-3">
						...
						<div class="u-nav-popup">
								<ul class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-nav-4">
									...
									<li class="u-nav-item"><a class="u-button-style u-nav-link" href="lessonList.jsp">레슨목록</a></li>
...
<!-- 로그인 시 닉네임 출력 -->
				...
				<p class="u-text u-text-2">
					<span style="font-weight: 700;"></span><%=info.getID()%>님&nbsp;<span style="font-weight: 700;"></span>환영합니다</p>
				<%}%>
			</div>
		</div>
		</div>
		...
		<form action="./MIXSET.jsp" method="post" accept-charset="">
			<div class="u-container-style u-expanded-width-lg u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-group u-group-1">
				<div class="u-container-layout">
					<input type="submit" name="category" value="전체" class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-1">
...
<!-- 글작성버튼 -->
			<a href="MixsetUpload.jsp?id=<%=info.getID() %>" class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-70 u-radius-6 u-btn-12">글 작성</a>
<!-- 게시물 출력 -->
			<%if (list != null) {%>
